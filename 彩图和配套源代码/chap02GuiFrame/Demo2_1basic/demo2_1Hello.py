...
LabHello.setGeometry(70, 60, size.width(), size.height())  # 设置LabHello的位置和大小，位置x=70,y=60， 宽度和高度由aLabSize的值确定
